import type { AnalysisResults, Message, EmotionalBreakdown } from "./types"
...
function profileToBreakdown(profile: any, sentiment: number): EmotionalBreakdown {

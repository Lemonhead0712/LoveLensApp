    ...
    <CompactPageLayout title="Contact Us" description="Get in touch with the Love Lens team">
      <div className="grid gap-8 md:grid-cols-2">
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <Mail className="mr-3 h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start">
                <Phone className="mr-3 h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
                <div>
          ...
          <section>
            <h2 className="text-xl font-bold mb-4 text-purple-700">Response Time</h2>
            <p className="text-gray-700 leading-relaxed">

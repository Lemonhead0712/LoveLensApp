...
export default function TermsPage() {
  return (
    <CompactPageLayout title="Terms of Service" description="Rules and guidelines for using Love Lens">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-3 text-purple-700">Use of Service</h2>
        <h3 className="text-lg font-semibold mb-1.5 text-purple-600">Eligibility</h3>
        <p className="mb-3 text-gray-700">
        ...
        <h3 className="text-lg font-semibold mb-1.5 text-purple-600">User Accounts</h3>
        <p className="mb-3 text-gray-700">
        ...
        <h3 className="text-lg font-semibold mb-1.5 text-purple-600">Acceptable Use</h3>
        <p className="mb-3 text-gray-700">You agree not to use the Service:</p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-3 text-purple-700">Content</h2>
        <p className="mb-3 text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-3 text-purple-700">Intellectual Property</h2>
        <p className="mb-3 text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-3 text-purple-700">Disclaimer</h2>
        <p className="mb-3 text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-3 text-purple-700">Limitation of Liability</h2>
        <p className="mb-3 text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-3 text-purple-700">Termination</h2>
        <p className="mb-3 text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-3 text-purple-700">Governing Law</h2>
        <p className="mb-3 text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-3 text-purple-700">Changes to Terms</h2>
        <p className="mb-3 text-gray-700">

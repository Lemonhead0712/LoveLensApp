  ...
  return (
    ...
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-xl font-bold mb-4 text-purple-700">Our Mission</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-4 text-purple-700">Our Vision</h2>
          <p className="mb-4 text-gray-700 leading-relaxed">
            We envision a world where technology serves as a bridge to deeper human connection rather than a barrier.
            Love Lens represents our commitment to using AI ethically and responsibly to strengthen the bonds between
            partners.
          </p>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold mb-4 text-purple-700">Our Approach</h2>
          <p className="mb-4 text-gray-700 leading-relaxed">
            Love Lens is built on a foundation of research-backed relationship science, including the Gottman Method,
            attachment theory, and modern communication studies. We combine this knowledge with advanced natural
            language processing to identify patterns that might otherwise go unnoticed.
          </p>
          <p className="text-gray-700 leading-relaxed">
            What sets us apart is our commitment to privacy. Unlike other tools that might store your conversations or
            require you to share intimate details, Love Lens analyzes screenshots locally and never stores the content
            of your messages. We only provide insights about patterns, not judgments about specific exchanges.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-bold mb-4 text-purple-700">Our Team</h2>
          <p className="mb-4 text-gray-700 leading-relaxed">
            Love Lens was founded by Lamar Newsome, a relationship coach with over 15 years of experience helping
            couples navigate communication challenges. After witnessing the same patterns emerge across hundreds of
            relationships, Lamar envisioned a tool that could help couples identify these patterns earlier and more
            objectively.
          </p>
          <p className="text-gray-700 leading-relaxed">

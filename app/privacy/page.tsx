...
export default function PrivacyPage() {
  return (
    <CompactPageLayout title="Privacy Policy" description="How we handle your data and protect your privacy">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-purple-700">Information Collection and Use</h2>
        <h3 className="text-xl font-semibold mb-2 text-purple-600">Conversation Analysis</h3>
        <p className="mb-4 text-gray-700">
        ...
        <h3 className="text-xl font-semibold mb-2 text-purple-600">Account Information</h3>
        <p className="mb-4 text-gray-700">
        ...
        <h3 className="text-xl font-semibold mb-2 text-purple-600">Usage Data</h3>
        <p className="mb-4 text-gray-700">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-purple-700">Data Security</h2>
        <p className="mb-4 text-gray-700">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-purple-700">Data Retention</h2>
        <p className="mb-4 text-gray-700">We retain different types of data for different periods:</p>
        <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
          <li>
